...
{	
	public:
		...
		virtual float SquareCalculate() = 0;
};
...
class Circle: public Shape
{
	...
	public:
		...
		Circle(float rr)
			{ r = rr; cout << "Using Circle's constructor." << endl; system("pause"); }
		~Circle()
...
class Quadrate: public Rectangle
{
	public:
		Quadrate()
			{ a = 1; cout << "Using Quadrate's constructor." << endl; system("pause"); }
		Quadrate(float aa)
